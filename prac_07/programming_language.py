...
class ProgrammingLanguage:
    ...
    def __repr__(self):
        ...
        return f"{self.name}, {self.typing} Typing, Reflection={self.reflection}, Arithmetic={self.arithmetic}, First appeared in {self.year}"
    ...
    def is_arithmetic(self):
        """Determine if language has an arithmetic type."""
        return self.arithmetic == "Arithmetic"
...
def run_tests():
    ...
    print("The arithmetically typed languages are:")
    for language in languages:
